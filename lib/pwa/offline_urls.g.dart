...
final List<String> offlineUrls = [
  ...
  './css/icon.css',
  './favicon.png',
  './files/post_template.csv',
  './fonts/FontAwesome.otf',
  './fonts/Gilroy/Gilroy-ExtraBold 800.otf',
  './fonts/Gilroy/Gilroy-Light 300.otf',
  './fonts/Google/ProductSans-Light.ttf',
  './fonts/Google/ProductSans-Thin.ttf',
  './fonts/Nexa/Nexa Bold 650.otf',
  './fonts/Nexa/NexaLight350.otf',
  './fonts/Nyata/NyataFTR-Regular.otf',
  './fonts/fontawesome-webfont.eot',
  './fonts/fontawesome-webfont.svg',
  './fonts/fontawesome-webfont.ttf',
  './fonts/fontawesome-webfont.woff',
  './fonts/fontawesome-webfont.woff2',
  './fonts/material-icon/material.woff2',
  './img/app-bg-01.jpg',
  './img/bg-new.jpg',
  './img/display_chat.png',
  './img/dropdown-1.png',
  './img/dropdown-10.svg',
  ...
  './img/postit-01.svg',
  './img/postit-fav.png',
  './img/postit-home-bg.svg',
  './img/postit-logo-new.png',
  './img/postit-name.png',
  './img/postit-name.svg',
  './img/postit-ui-bg.png',
  './img/postit.png',
  './img/postit.svg',
  './img/postit_background.png',
  './img/postit_black.svg',
  './img/postit_home.png',
  './img/side_bg.png',
  './img/svg-bg-01.png',
  './img/svg-bg.png',
...
final String lastModified = '2021-04-11T12:32:51.000Z';
