...
class PostAccountComponent implements OnInit {
  ...
  void gotoFacebook() {
    ...
    loginLinkUrl = 'https://www.facebook.com/v9.0/dialog/oauth/?display=popup&client_id=$appId&redirect_uri=$url&state=access_token&scope=pages_manage_posts,pages_read_engagement,pages_show_list,pages_manage_engagements,pages_read_user_content';
  }
