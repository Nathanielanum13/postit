...
class InnerRoutePaths {
  ...
  static final create_post =
      RoutePath(path: 'create_post', parent: _parent.RoutePaths.dashboard);
  static final manage_post =
      RoutePath(path: 'manage_post', parent: _parent.RoutePaths.dashboard);
  static final view_post =
      RoutePath(path: 'view_post', parent: _parent.RoutePaths.dashboard);
  static final post_account =
      RoutePath(path: 'post_account', parent: _parent.RoutePaths.dashboard);
  static final user_account =
